...
import { PROGRAM_REPOSITORY, ProgramRepository } from '../program/repositories/program-repository.interface'
...
export class WorkoutService {
  ...
  async create(workoutInput: WorkoutInput): Promise<Workout> {
    const program = await this.programRepository.getProgram(workoutInput.programId)
