...
let GraphQLFactory = class GraphQLFactory {
    ...
    async mergeOptions(options = { typeDefs: [] }) {
        const resolvers = this.resolversExplorerService.explore();
        const typesResolvers = (0, utils_2.extend)(this.scalarsExplorerService.explore(), resolvers);
        options.plugins = (0, utils_2.extend)(options.plugins || [], this.pluginsExplorerService.explore());
        ...
        if (options.autoSchemaFile) {
            ...
            const executableSchema = (0, schema_1.makeExecutableSchema)({
                resolvers: (0, utils_2.extend)(typesResolvers, options.resolvers),
      ...
      `,
        ...
        let schema = options.schema
            ...
            : executableSchema;
        (0, utils_2.removeTempField)(schema);
        schema = await transformSchema(schema);
        schema = options.sortSchema ? (0, graphql_1.lexicographicSortSchema)(schema) : schema;
        this.gqlSchemaHost.schema = schema;
        return {
    ...
    async generateDefinitions(typeDefs, options) {
        ...
        const tsFile = await this.graphqlAstExplorer.explore((0, apollo_server_core_1.gql) `
        ${typeDefs}
