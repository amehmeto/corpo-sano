...
exports.GraphQLSubscriptionService = void 0;
...
class GraphQLSubscriptionService {
    ...
    initialize() {
        ...
        this.httpServer.on('upgrade', (req, socket, head) => {
            ...
            const wss = (protocols === null || protocols === void 0 ? void 0 : protocols.includes(subscriptions_transport_ws_1.GRAPHQL_WS)) &&
...
exports.GraphQLSubscriptionService = GraphQLSubscriptionService;
