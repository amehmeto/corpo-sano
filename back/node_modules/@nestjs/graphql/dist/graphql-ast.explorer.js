...
let GraphQLAstExplorer = class GraphQLAstExplorer {
    ...
    getFieldTypeDefinition(typeNode, options) {
        ...
        if (isArray) {
            const { type: arrayType, required: arrayTypeRequired, } = this.getNestedType((0, lodash_1.get)(type, 'type'));
            const typeName = this.addSymbolIfRoot((0, lodash_1.get)(arrayType, 'name.value'));
    ...
    getNestedType(type) {
        ...
        if (isNonNullType) {
            return {
                type: this.getNestedType((0, lodash_1.get)(type, 'type')).type,
...
GraphQLAstExplorer = (0, tslib_1.__decorate)([
