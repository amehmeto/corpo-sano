...
let GraphQLSchemaFactory = GraphQLSchemaFactory_1 = class GraphQLSchemaFactory {
    ...
    async create(resolvers, scalarsOrOptions = [], options = {}) {
        ...
        if (!options.skipCheck) {
            ...
            const { errors } = await (0, graphql_1.graphql)(schema, introspectionQuery);
            if (errors) {
...
GraphQLSchemaFactory = GraphQLSchemaFactory_1 = (0, tslib_1.__decorate)([
    (0, common_1.Injectable)(),
    (0, tslib_1.__metadata)("design:paramtypes", [query_type_factory_1.QueryTypeFactory,
