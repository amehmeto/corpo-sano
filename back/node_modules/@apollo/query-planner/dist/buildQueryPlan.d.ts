import { DocumentNode, FragmentDefinitionNode, GraphQLCompositeType, GraphQLSchema, OperationDefinitionNode, DirectiveNode } from 'graphql';
...
export declare function findDirectivesOnNode<T extends {
    directives?: readonly DirectiveNode[];
}>(node: T, directiveName: string): DirectiveNode[];
