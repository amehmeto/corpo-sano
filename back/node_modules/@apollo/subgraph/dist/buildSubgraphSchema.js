...
function buildSubgraphSchema(modulesOrSDL) {
    ...
    const modules = (0, apollo_graphql_1.modulesFromSDL)(shapedModulesOrSDL);
    let schema = (0, apollo_graphql_1.buildSchemaFromSDL)(modules, new graphql_1.GraphQLSchema({
        query: undefined,
        directives: [...graphql_1.specifiedDirectives, ...directives_1.directivesWithNoDefinitionNeeded],
    }));
    ...
    schema = (0, apollo_graphql_1.transformSchema)(schema, (type) => {
    ...
    for (const module of modules) {
        if (!module.resolvers)
            continue;
        (0, apollo_graphql_1.addResolversToSchema)(schema, module.resolvers);
    }
    return schema;
}
