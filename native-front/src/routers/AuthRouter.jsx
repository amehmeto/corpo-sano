...
exports.AuthRouter = exports.checkAuthorization = exports.Routes = void 0;
var native_stack_1 = require("@react-navigation/native-stack");
var React = require("react");
var LoginScreen_1 = require("../login/LoginScreen");
...
var routes = [
    { name: 'Login', component: LoginScreen_1.default },
];
var Routes;
(function (Routes) {
    Routes["LOGIN"] = "Login";
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    isAuth = _a.sent();
                    return [2 /*return*/, Promise.resolve(!!isAuth)];
            }
        });
    });
}
